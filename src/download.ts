 ...
 * marker, no init handover; that's `create`. This is the building block for side-by-side comparisons (`update` uses
 * the same internals) and for grabbing the source without starting an app.
 *
